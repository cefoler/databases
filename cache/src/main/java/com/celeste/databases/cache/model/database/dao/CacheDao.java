...
public interface CacheDao extends Dao {
  ...
  Long expire(final String key, final long seconds) throws FailedConnectionException;

  String expire(final String key, final String value, final long seconds)
      throws FailedConnectionException;

  void increment(final String key, final String value, final double amount)
      throws FailedConnectionException;
